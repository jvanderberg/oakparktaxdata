...
combined['taxpreviousyear'] = .12686 *( combined['eavpreviousyear']- combined['homeownerexemption'] * 10000)
combined['estnewtax'] = .0965 *( combined['combinedassessedvalue'] * 2.9109 - combined['homeownerexemption'] * 10000)
