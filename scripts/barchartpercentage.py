...
p5 = plt.bar(year,village, width, color='#990099', bottom=park + town + d200 + d97)

plt.ylabel("Tax Levy %")
plt.title('Oak Park Tax Levy Relative Percentage by Year')
plt.xticks([1999, 2005, 2010, 2016])
plt.grid(axis='y', linewidth=0.5)
plt.legend((p1[0], p2[0], p3[0], p4[0], p5[0]), ('D200', 'D97', 'Oak Park Township', 'Park District', 'Village of Oak Park'), loc='lower left')

plt.savefig('charts/percentage levy by year.png')